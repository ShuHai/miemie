...
// 数组求交集
Array$1.prototype.intersection = function intersection () {
    var this$1 = this;

  console.log(arguments);
  var args = Array$1.prototype.slice.call(arguments);
  console.log(args);
  console.log('test');
  var arr = [];
  args.map(function (item) {
    arr = arr || this$1.isArray(item) ? item : arr;
...
// 数组求并集
Array$1.prototype.union = function union () {

};

// 数组求差集
Array$1.prototype.difference = function difference () {
